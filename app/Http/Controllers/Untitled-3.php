    ...
    font-size: 22px;
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="activerotas" role="tabpanel"
                      ...
                      <form class="active-rots-slt-from">
                        <div class="row">
                          ...
                          <div class="col-lg-4 col-md-4">
                            <input type="text" placeholder="Select range..." class="form-control date_picker">
                          </div>
                          <div class="col-lg-3 col-md-3">
                          ...
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="col-md-10 px-2">
                              <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                  <button class=" my-2 d-flex justify-content-center align-items-center three_dot_btn" type="button" id="rota_click_update" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="dropbtn">
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="col-md-5">
                                        <input type="text" id="rota_id" name="rota_id" value="{{ $rota_list_data->id }}">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <button type="button" id="rename_rota_btn" class="save_btn_modal">Save</button>
                                      </div>
                                    </div>
                                  </div>
                                </div> 
                      ...
                      <div class="col-lg-12">
                        ...
                        <!-- <h4>Published rotas</h4> -->
                                  ...
                                  <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="box-date-info-area">
                                      <div class="date-and-day">
                                        <h5>{{ \Carbon\Carbon::parse($rota_list_data->rota_start_date)->format('D jS M')}}</h5>
                                      </div>
                                      <div class="shift-box-info">
                                        <h3><a href="#">{{ $rota_list_data->rota_name }}</a></h3>
                                        <p>Total: 28 hrs 56 mins (Incl. breaks)</p>
                                        <p><span>{{ $rota_list_data->rota_duration }} days, </span> <span>3 employees</span></p>
                                      </div>
                                    </div>
                                  </div>
                                @endif
                          ...
                          <!-- @if(empty($rota_list_data->status == 1) )
                    ...
                    <div class="tab-pane fade" id="oldrotas" role="tabpanel" aria-labelledby="oldrotas-tab">
                      ...
                      <div class="no-rate-see">
                        <h4>Published rotas</h4>
                          <div class="row">
                            @foreach($rota_list as $rota_list_data)
                              @if($rota_list_data->status == 1)
                                  <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="box-date-info-area">
                                      <div class="date-and-day">
                                        <h5>{{ \Carbon\Carbon::parse($rota_list_data->rota_start_date)->format('D jS M')}}</h5> <?php  
                                         echo date('Y-m', strtotime(date($rota_list_data->rota_start_date)." -1 month"));
                                        ?>
                                      </div>
                                      <div class="shift-box-info">
                                        <h3><a href="#">{{ $rota_list_data->rota_name }}</a></h3>
            ...
            <!-- <div class="col-lg-3 col-md-3">
              <div class="side-bar-info">
                <div class="slider-bar-post-thumbs"> <img src="{{ url('frontEnd/staff/images/960x0.jpg') }}"> </div>
...
<script>
  $('#rota_click_update').click(function(){
    var rota_id =  document.getElementById('rota_id').value;
    var rota_rename_id =  document.getElementById('rota_rename_id').value = rota_id;
  ...
  $( document ).ready(function() {
    console.log( "ready!" );
    $('#rename_rota_btn').on('click', function(){
        var shift_name = document.getElementById('team-name').value;
        var rota_id =  document.getElementById('rota_id').value;
