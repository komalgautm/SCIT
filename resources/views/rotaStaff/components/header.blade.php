...
<head>
  ...
  <link href="{{ url('frontEnd/staff/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ url('frontEnd/staff/css/font-awesome.min.css') }}" rel="stylesheet">
  <link href="{{ url('frontEnd/staff/css/style.css') }}" rel="stylesheet"> 
  ...
  <link href="{{ url('frontEnd/staff/css/main.css') }} " rel="stylesheet">
  <script src="{{ url('frontEnd/staff/js/main.js') }}"></script>
</head>
<style>
  .header_link {
    display: none;
    ...
    <div class="container-fluid p-0">
      <div class="row m-0">
        ...
        <div class="left-sidebar-info">
            <a href="./personal-detail.html" class="user-name-crical"> MR </a>
            <div class="nav-links">
              <nav>
                <ul>
                  <li><a href="#"><i class="fa fa-bell"></i></a></li> 
                  <li><button href="#" class="openbtn"  onclick="openNav()"><span class="plus_icon"><i class="fa fa-plus-circle"></i></span>Actions</button></li>
            ...
            <div class="row position">
              ...
              <div class="col-lg-6 right_links col-md-6 d-flex justify-content-end">
                ...
                <div class="logout-right">
                  <h4><a href="#"><i class="fa fa-sign-in"></i> Logout</a></h4> </div>
              </div>
            </div>